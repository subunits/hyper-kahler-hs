...
- C: a2 = 0    (single-spin limit, recovers baseline exactly)

### Spin symmetry fingerprint
Classifies each signal by its Chern proxy structure:
...
Key findings:
- ISCO is non-Lagrangian: resI ~ -resK (I/K antisymmetry) throughout
- MP d=6 single-spin is Lagrangian in I; cJ=cK=0 exactly
- MP d=6 equal-spin: dωI = dωJ, dωK = 0 at every triple — SU(2) in curvature
- Regime C recovers the single-spin baseline to 4 decimal places
- Black ring: competing I and K Chern proxies reflect S1 and S2 rotation directions
...
- No GL instability check in the HK layer yet.
...
4. **GL instability in H^k** — embed (r_H, a, k, Im_Omega) as a quaternion
   and track Chern proxy change as k crosses k_GL.
...
5. github.com/subunits/avsp
6. github.com/subunits/kahler-ts
7. github.com/subunits/bh-phase-space
8. github.com/subunits/hyper-kahler-hs
